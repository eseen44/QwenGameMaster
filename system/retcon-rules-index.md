...
Regul z klauzula normatywna: **119** z 200 retconow.
...
- `retcon_000200` — DO CZASU POTWIERDZENIA narrator NIE ORZEKA, ze gdziekolwiek nie ma przejscia.
...
- `retcon_000194` — To jest cala tresc jego pamieci o tym miejscu i narratorowi nie wolno jej rozszerzac.

## energia i ekonomia slug (15)
...
- `retcon_000193` — DOWOZ DO VARKHENA PODWOJONY NA ZYCZENIE GRACZA, ale nie dokladnie dwa razy, bo SUFIT WOLNEJ NADWYZKI JEST NIZSZY.
